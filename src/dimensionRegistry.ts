...
export const DIMENSION_REGISTRY: DimensionMeta[] = [
    ...
    { key: 'Target Precision',            displayName: 'Target Precision',            category: 'market',      isRiskDimension: false, moatEligible: true,  nullSignalScore: 20 },
    { key: 'Trend Adoption',              displayName: 'Trend Adoption',              category: 'market',      isRiskDimension: false, moatEligible: true,  nullSignalScore: 20 },
    { key: 'Team / Founder Strength',     displayName: 'Team / Founder Strength',     category: 'market',      isRiskDimension: false, moatEligible: true,  nullSignalScore: 20 },
    ...
    { key: 'CAC/LTV Ratio',               displayName: 'CAC/LTV Ratio',               category: 'commercial',  isRiskDimension: false, moatEligible: true,  nullSignalScore: 20 },
    { key: 'Market Entry Speed',          displayName: 'Market Entry Speed',          category: 'commercial',  isRiskDimension: false, moatEligible: true,  nullSignalScore: 20 },
    { key: 'Execution Speed',             displayName: 'Execution Speed',             category: 'operations',  isRiskDimension: false, moatEligible: true,  nullSignalScore: 20 },
